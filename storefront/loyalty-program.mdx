...
| Tier | ID | Minimum Spent | Discount Multiplier | Free Shipping |
|------|----|--------------|---------------------|---------------|
| Bronze | `bronze` | $0 MXN | Base rate | No |
| Silver | `silver` | Configurable | 1.x multiplier | Above minimum |
| Gold | `gold` | Configurable | Higher multiplier | Yes |
| Platinum | `platinum` | Configurable | Maximum multiplier | Yes |

```typescript
// Re-exported from loyalty.service.ts
type Tier = 'bronze' | 'silver' | 'gold' | 'platinum';

// customer_profiles.customer_tier stores the current tier
